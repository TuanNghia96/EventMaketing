    ...
    <form action="{{ route('admin.store') }}" method="POST">
        ...
        <div class="card-body">
            <div class="form-group @error('email') has-error @enderror">
                ...
                <input type="text" class="form-control" id="name" name="email" placeholder="" value="{{ old('email') }}">
                @error('email')
        ...
        <div class="card-body">
            <div class="form-group @error('birthday') has-error @enderror">
                ...
                <div class="input-group">
                    <input type="text" class="form-control" id="datepicker" name="birthday" value="{{ old('birthday') }}">
