        ...
        <div class="row">
            <div class="col-12">
                <article class="events-news-post">
                    ...
                    <figure>
                        <a href="#"><img src="{{ asset('frontend/images/news-1.jpg') }}" alt=""></a>
                ...
                <article class="events-news-post">
                    ...
                    <figure>
                        <a href="#"><img src="{{ asset('frontend/images/news-2.jpg') }}" alt=""></a>
                ...
                <article class="events-news-post">
                    ...
                    <figure>
                        <a href="#"><img src="{{ asset('frontend/images/news-3.jpg') }}" alt=""></a>
