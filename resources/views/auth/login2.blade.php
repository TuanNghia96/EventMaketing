                        ...
                        <form id="exampleValidation" method="POST" action="{{ route('login') }}">
                            ...
                            <div class="card-body text-center">
                                <div class="form-group row @error('email') has-error @enderror">
                                    <label for="email" class="col-lg-4 col-md-4 col-sm-4 mt-sm-2 text-right">Email (or user name)<span class="required-label">*</span></label>
                                ...
                                <div class="form-group form-show-validation row @error('password') has-error @enderror">
                                    <label for="password" class="col-lg-4 col-md-4 col-sm-4 mt-sm-2 text-right">Password <span class="required-label">*</span></label>
                                    <div class="col-lg-4 col-md-9 col-sm-8">
